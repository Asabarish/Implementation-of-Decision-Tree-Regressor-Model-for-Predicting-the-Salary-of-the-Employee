...
## Algorithm
1. Import required libraries and create the **salary dataset using Pandas**.
2. Separate the dataset into **feature (Level)** and **target variable (Salary)**.
3. Create and train the **Decision Tree Regressor model** using the dataset.
4. Use the trained model to **predict salaries for existing or new levels**.
5. Visualize the results using a **scatter plot for actual data and a curve for predicted values**.
...
## Output:
<img width="1429" height="576" alt="image" src="https://github.com/user-attachments/assets/c7650fea-34ec-48c5-85d7-c2792d000bab" />
